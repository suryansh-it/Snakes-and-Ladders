...
class Player(pg.sprite.Sprite):
    ...
    def __init__(self,win_ref,color,board_matrix_ref,name) -> None:
        ...
        self.block_size = 80
        self.image=pg.image.load(f"assets/player_{color}.png").convert_alpha()
    ...
    # def match_pattern(self,transporter_value):
    #     return (transporter_value.startswith("l_") or transporter_value.startswith("s_")) and transporter_value.endswith("_s")
